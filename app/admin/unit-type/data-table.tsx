...
import CreateUnitTypeForm from "./action/createForm";
import { ColumnFilter } from "./action/columnFilter";
import ExportUnitTypeCSVButton from "./action/exportBulk";
import ImportUnitTypeCSV from "./action/importBulk";
...
interface DataTableProps {
  columns: ColumnDef<UnitType, unknown>[];
  data: UnitType[];
}
    ...
    <div>
      <div className="flex flex-col ">
        ...
        <div className="flex items-center justify-between">
          ...
          />
          <p>Buat kategori <span className="font-bold text-primary"> struktur organisasi dalaman (internal organization structure).</span></p>
        </div>
        <div className="mb-3 flex items-start justify-between gap-4">
          ...
          <div className="overflow-hidden gap-4 basis-[30%] max-w-[30%] self-start">
            ...
            <div className="bg-primary overflow-hidden p-5 rounded-md border self-start">
              <span className="font-semibold text-white">Add Organisasi Type</span>
              <CreateUnitTypeForm />
            </div>
          </div>
          ...
          <div className="overflow-hidden p-5 rounded-md border basis-[70%] max-w-[70%]">
            <div className="mb-3 flex items-center justify-between">
              <p className="font-semibold">
                Total Organisasi Type : <span className="font-semibold text-primary text-xl">{data.length}</span>
              </p>
              <div className="flex gap-1">
                <ImportUnitTypeCSV setImportProgress={setImportProgress} />
                <ExportUnitTypeCSVButton data={data} />
